...
>
> For design system context (when to use variants vs properties, code-to-Figma translation, property model), see [wwds-components](../../figma-design-systems/references/wwds-components.md).
