...
>
> For design system context (effect types, variable bindings on effects, gotchas), see [wwds-effect-styles](../../figma-design-systems/references/wwds-effect-styles.md).
