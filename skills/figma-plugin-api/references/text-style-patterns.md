...
>
> For design system context (when to create text styles, how they relate to tokens, headless limitations), see [wwds-text-styles](../../figma-design-systems/references/wwds-text-styles.md).
