...
For runnable code examples (listing, creating, probing fonts, type ramps, applying styles), see [text-style-patterns.md](../../figma-plugin-api/references/text-style-patterns.md).
