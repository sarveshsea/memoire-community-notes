...
For runnable code examples (creating, importing, discovering, inspecting components), see [component-patterns.md](../../figma-plugin-api/references/component-patterns.md).
